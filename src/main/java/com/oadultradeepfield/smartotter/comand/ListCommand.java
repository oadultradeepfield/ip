...
public class ListCommand implements Command {
    /**
     * Creates a {@code ListCommand} from user input.
     * This command ignores any provided input.
     *
    ...
    public void execute(CommandContext context) {
        ...
        CustomIO.printPretty(result.isEmpty() ? "Congratulations! You don't have any tasks at the moment." : result);
    }
}
